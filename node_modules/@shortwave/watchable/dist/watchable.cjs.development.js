...
function useMemoizedWatchable(w, deps) {
  ...
  return useWatchable(react.useMemo(w, deps));
}
/*
...
function useExplicitWatchable(loading, w) {
  var _useState = react.useState(w.hasValue() ? w.getValue() : loading),
      value = _useState[0],
...
exports.WatchableSubject = WatchableSubject;
exports.partialCombineWatchable = partialCombineWatchable;
exports.useExplicitWatchable = useExplicitWatchable;
exports.useMemoizedWatchable = useMemoizedWatchable;
exports.useWatchable = useWatchable;
//# sourceMappingURL=watchable.cjs.development.js.map
